...
public class Option6 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        mainLabel.setText(language.getContentByName("mainLabel", 5) + " " + language.getContentById("options"));
    ...
    private boolean submittingForm() {
        try {
            ...
            Logger.getLogger(Option6.class.getName()).log(Level.SEVERE, null, ex);
        }
