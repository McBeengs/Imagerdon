...
public class SetupFAJPanel extends javax.swing.JPanel {

    private final XmlManager xml;
    private final XmlManager language;
    private final PasswordManager pass;
    
    public SetupFAJPanel(XmlManager xml) {
        this.xml = xml;
    ...
    private void initComponents() {
        ...
        artistNameLabel.setText("Alpha V3 - Setup (FurAffinity)");
    ...
    private boolean submittingForm() {
        try {
            ...
            Logger.getLogger(SetupFAJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
