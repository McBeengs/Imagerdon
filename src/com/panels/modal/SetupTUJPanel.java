...
public class SetupTUJPanel extends javax.swing.JPanel {

    private final XmlManager xml;
    private final XmlManager language;
    private final PasswordManager pass;
    
    public SetupTUJPanel(XmlManager xml) {
        this.xml = xml;
    ...
    private void initComponents() {
        ...
        artistNameLabel.setText("Alpha V3 - Setup (Tumblr)");
    ...
    private boolean submittingForm() {
        try {
            ...
            Logger.getLogger(SetupTUJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
